  ...
  return (
    <div className="flex justify-end gap-2">
      <button
        ...
        className="inline-flex size-8 items-center justify-center rounded border border-red-100 text-red-600"
      >
        ...
        <div className="fixed inset-0 z-50 grid place-items-center bg-black/35 px-4">
          <div className="w-full max-w-sm rounded-lg bg-white p-5 text-left shadow-xl">
            ...
            <p className="mt-2 text-sm font-medium text-zinc-500">
              {product.name} will be removed from products and timeline.
            </p>
            <div className="mt-5 flex justify-end gap-2">
              ...
              <button
                ...
                disabled={deleting}
                className="min-h-10 rounded bg-red-600 px-4 text-sm font-black text-white disabled:opacity-60"
              >
