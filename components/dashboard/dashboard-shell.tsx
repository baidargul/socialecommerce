      ...
      <header className="sticky top-0 z-20 border-b border-zinc-200 bg-white">
        <div className="flex h-14 items-center justify-between px-5">
          <div className="flex items-center gap-3">
            <div className="grid size-8 place-items-center rounded bg-gradient-to-tr from-[#feda75] via-[#d62976] to-[#4f5bd5] text-sm font-black text-white">
              SC
            </div>
            <div>
          ...
          <div className="flex items-center gap-3">
            <span className="hidden text-sm font-bold text-zinc-600 sm:inline">
              @{user.username}
            </span>
            <Link
              href="/profile"
              className="inline-flex min-h-9 items-center gap-2 rounded border border-zinc-200 bg-white px-3 text-sm font-bold text-zinc-800"
            >
