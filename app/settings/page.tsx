  ...
  return (
    <MobileShell>
      <div className="px-5 py-6">
        <Link href="/profile" className="inline-flex items-center gap-2 text-sm font-black text-zinc-600">
          <ChevronLeft className="size-4" />
          Profile
        </Link>
        <div className="mt-4">
          <h1 className="text-4xl font-black">Settings</h1>
          <p className="mt-2 text-base font-medium text-zinc-500">Manage your account identity and password.</p>
        </div>
        <div className="mt-6">
